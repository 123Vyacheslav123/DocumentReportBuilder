...
namespace Report_Generator
{
    ...
    { 
        ...
        protected void ButtonDownload_Click(object sender, EventArgs e)   // кнопка скачивания документа
        {
            ...
            var doc = DocX.Load("C://Users//Admin//Desktop//Test.docx");
        ...
        protected void ButtonChoose_Click(object sender, EventArgs e)  // поиск по Value из DropDownListForElements
        {
            ...
            string STR = Numb_Sy.Text.ToString();
            int kol_Sy = Int32.Parse(STR);
            int kol_Main = MainTextBox.Text.Length;
            string SRT1 = MainTextBox.Text.ToString();
            int SUM = kol_Main + kol_Sy;
            if ((DropDownListForElements.SelectedItem.Value) =="0") // если найдено Value для текста
            {
                TextBoxEditing.Text ="\u2007\u2007\u2007\u2007\u2007";  //красная строка
                MainTextBox.Enabled = false;
            }
           else if ((DropDownListForElements.SelectedItem.Value) == "4")
            {
               
                Ready.Visible = true;
                MainTextBox.Enabled = true;
                MainTextBox.MaxLength = kol_Sy+MainTextBox.Text.Length;
        ...
        protected void ButtonAddTable_Click(object sender, EventArgs e)
        {
            ...
            int Columns_int = Int32.Parse(Columns);
                ...
                doc.InsertTable(t);
                doc.SaveAs("C://Users//Admin//Desktop//Test.docx");
        ...
        {
            string filename = "C://Users//Admin//Desktop//Test.docx";
        ...
        protected void Numb_Sy_TextChanged(object sender, EventArgs e)
        {
